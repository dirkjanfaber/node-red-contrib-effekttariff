      ...
      customChecks: [
        {
          ...
          expected: true,
          check: (results) => {
            // All charging should happen outside peak hours (17-21)
        ...
        },
        {
          ...
          expected: true,
          check: (results) => {
            // During peak hours (17-21), charge rate should be 0
            const peakHourData = results.batteryData.filter(b => b.hour >= 17 && b.hour < 21)
