...
const scenarios = {
  ...
  // ============================================================================
  // BELGIUM SCENARIOS (Capaciteitstarief)
  // ============================================================================

  /**
   * Belgium basic scenario
   * Tests: Belgian capacity tariff with 15-minute intervals and single peak per month
   */
  belgiumBasic: {
    name: 'Belgium Basic',
    description: 'Belgian capacity tariff with 15-minute intervals and single peak per month',
    analysis: `<strong>What this proves:</strong> Belgium's capacity tariff (capaciteitstarief) uses a different model than Sweden.
      Instead of averaging multiple peaks, Belgium charges based on your single highest 15-minute peak each month. This simulation
      ...
      there are no off-peak hours or seasons. This makes peak shaving with a battery even more valuable in Belgium.`,
    config: {
      region: 'belgium',
  ...
  /**
   * Belgium EV charging scenario
   * Tests: Impact of occasional 11kW EV charging on Belgian capacity tariff
   */
  belgiumWithEV: {
    name: 'Belgium EV Charging',
    description: 'Belgian household with occasional 11kW EV charging showing peak impact',
    analysis: `<strong>What this proves:</strong> In Belgium, a single 15-minute period of 11kW EV charging creates an 11kW peak
      that affects your capacity fee for the entire year. This simulation shows a typical Belgian household with occasional evening
      ...
      during EV charging. This demonstrates why peak shaving is especially valuable for Belgian EV owners - limiting charging peaks
  ...
  /**
   * Belgium annual rolling average scenario
   * Tests: 12-month rolling average calculation
   */
  belgiumAnnualRolling: {
    name: 'Belgium Annual Rolling',
    description: 'Full year simulation showing 12-month rolling average for Belgian billing',
    analysis: `<strong>What this proves:</strong> Belgium calculates your annual capacity fee based on the average of your monthly
