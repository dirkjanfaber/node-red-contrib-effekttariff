    ...
    <div class="analysis">
      ...
      <div class="analysis-grid">
        <div class="analysis-item">
          <div class="analysis-label">Without Peak Shaving</div>
          <div class="analysis-value">${results.summary.analysis.baselinePeakAverageKw} kW</div>
          <div class="analysis-subtext">Baseline peak average</div>
        </div>
        <div class="analysis-item">
          <div class="analysis-label">With Peak Shaving</div>
          <div class="analysis-value">${results.summary.analysis.achievedPeakAverageKw} kW</div>
          <div class="analysis-subtext">Achieved peak average</div>
        </div>
        <div class="analysis-item">
      ...
      ${results.summary.analysis.baselinePeakAverageKw > 0 ? `
      <div class="analysis-explanation">
        <strong>Monthly Cost Impact:</strong> Based on typical Swedish effekttariff rates (~50 SEK/kW/month),
        this ${results.summary.analysis.reductionKw} kW reduction could save approximately
        <strong>${results.summary.analysis.estimatedMonthlySavingSek} SEK/month</strong> on the power tariff portion of your grid fee.
        ${results.config.batteryEnabled && results.summary.batteryAnalysis ? `
        <br/><br/><strong>Battery Contribution:</strong> The battery discharged ${results.summary.batteryAnalysis.totalDischargeHours} hours
        to help shave peaks, with an average discharge rate of ${(results.summary.batteryAnalysis.avgDischargeRateW / 1000).toFixed(1)} kW.
        ` : ''}
      </div>
      ` : ''}
      <table class="comparison-table">
        ...
        <tbody>
          <tr>
            ...
            <td class="reduction">${results.summary.analysis.reductionPercent > 0 ? '-' + results.summary.analysis.reductionPercent + '%' : 'No change'}</td>
          </tr>
          <tr>
            <td>Highest Peak</td>
          ...
          <tr>
            ...
            <td class="reduction">${results.summary.analysis.estimatedMonthlySavingSek > 0 ? '-' + results.summary.analysis.estimatedMonthlySavingSek + ' SEK' : 'No savings'}</td>
          </tr>
        </tbody>
      </table>
