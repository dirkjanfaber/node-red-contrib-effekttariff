...
: ''}
    ...
    <div class="analysis">
      ...
      <div class="analysis-explanation">
        ...
        without active peak shaving. The system correctly identifies your top ${results.config.peakCount} consumption peaks
        and calculates that your current effektavgift would be approximately <strong>${Math.round(results.summary.analysis.achievedPeakAverageKw * 50)} SEK/month</strong>.
        <br/><br/>
        ...
        saving <strong>${Math.round(results.summary.analysis.achievedPeakAverageKw * 50 * 0.4)}-${Math.round(results.summary.analysis.achievedPeakAverageKw * 50 * 0.5)} SEK/month</strong>.
