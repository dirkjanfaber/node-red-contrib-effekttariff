...
function formatResults (results) {
  ...
  if (isBelgium) {
    lines.push(`║ Region: Belgium (${config.measurementIntervalMinutes || 60}-minute intervals)`)
  }
  lines.push('╠════════════════════════════════════════════════════════════════╣')
  ...
  if (isBelgium && summary.belgiumAnalysis) {
    lines.push('║ COST ANALYSIS (Belgium ~€50/kW/year):')
...
: ''}
    ...
    <div class="analysis">
      ...
      <div class="analysis-explanation">
        <strong>Annual Cost Impact:</strong> Belgian capacity tariff costs approximately €50/kW/year based on your 12-month rolling average.
        ...
        ` : ''}
        <br/><br/><strong>Why Belgium Matters:</strong> A single 15-minute high-power event (like 11kW EV charging) sets your monthly peak,
      ...
      `)}
      <div style="font-size: 11px; opacity: 0.7; margin-top: 10px;">*Estimated using ${isBelgiumReport ? 'Belgian capacity tariff rate of ~€50/kW/year' : 'typical Swedish effekttariff rate of ~50 SEK/kW/month'}. Actual rates vary by provider.</div>
    </div>
